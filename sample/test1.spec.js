...
module.exports = function(){
    ...
    it('url: http://www.bing.com', async function(){
        await driver.url(_(`http://www.bing.com`));
    });
    ...
    it('sendKeys: sdsd', async function(){
        await driver.sendKeys('sdsd');
    });

    it('click: #sb_form_go, 25, 14, 0', async function(){
        await driver.sleep(300).wait('#sb_form_go', 30000)
    ...
    it('click: #b_results div.b_snippet > p:nth-child(1), 286, -1, 0', async function(){
        await driver.sleep(300).wait('#b_results div.b_snippet > p:nth-child(1)', 30000)
               .sleep(300).mouseMove(286, -1).click(0);
    });
